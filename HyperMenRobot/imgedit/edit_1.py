...
async def bright(client, message):
    try:
        ...
        if not message.reply_to_message.empty:
            ...
            edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_brightness.jpg"
...
async def mix(client, message):
    try:
        ...
        if not message.reply_to_message.empty:
            ...
            edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_mix.jpg"
...
async def black_white(client, message):
    try:
        ...
        if not os.path.isdir(f"./DOWNLOADS/{userid}"):
            os.makedirs(f"./DOWNLOADS/{userid}")
        download_location = "./DOWNLOADS" + "/" + userid + "/" + userid + ".jpg"
        edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_black_white.jpg"
        if not message.reply_to_message.empty:
            msg = await message.reply_to_message.reply_text(
                "Downloading image", quote=True
            )
...
async def normal_blur(client, message):
    try:
        ...
        if not message.reply_to_message.empty:
            ...
            edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_BlurImage.jpg"
...
async def g_blur(client, message):
    try:
        ...
        if not message.reply_to_message.empty:
            ...
            edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_blur.jpg"
...
async def box_blur(client, message):
    try:
        ...
        if not message.reply_to_message.empty:
            ...
            edit_img_loc = "./DOWNLOADS" + "/" + userid + "/" + "HyPerMen_box_blur.jpg"
            im2.save(edit_img_loc)
            await message.reply_chat_action("upload_photo")
            await message.reply_to_message.reply_photo(edit_img_loc, quote=True)
            await msg.delete()
